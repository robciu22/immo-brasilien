...
# Mehrere Punkte pro Stadt entlang der tatsächlichen Küstenlinie
KUESTENPUNKTE = [
    # Fortaleza (CE) — Küste von West nach Ost
    (-3.7270, -38.6750), (-3.7225, -38.6200), (-3.7172, -38.5433),
    (-3.7160, -38.5100), (-3.7280, -38.4800), (-3.6900, -38.4500),

    # Natal (RN)
    (-5.8200, -35.2000), (-5.7945, -35.2110), (-5.7500, -35.2050),
    (-5.7200, -35.1900), (-5.6900, -35.1800),

    # Recife (PE)
    (-8.1000, -34.9000), (-8.0800, -34.8800), (-8.0476, -34.8770),
    (-8.0200, -34.8700), (-7.9800, -34.8400),

    # Salvador (BA) — Atlantikküste von Barra bis Stella Maris
    (-13.007, -38.532), (-13.003, -38.509), (-12.997, -38.499),
    (-12.990, -38.481), (-12.983, -38.464), (-12.975, -38.450),
    (-12.967, -38.432), (-12.960, -38.413), (-12.953, -38.395),
    (-12.944, -38.380), (-12.929, -38.360), (-12.918, -38.343),

    # Maceio (AL)
    (-9.6900, -35.7500), (-9.6658, -35.7350), (-9.6500, -35.7200),
    (-9.6300, -35.7100), (-9.6100, -35.7000),

    # Florianopolis (SC) — Insel mit mehreren Küstenabschnitten
    (-27.6800, -48.4600), (-27.6200, -48.5600), (-27.5954, -48.5480),
    (-27.5700, -48.5300), (-27.4800, -48.4600), (-27.4300, -48.4000),

    # Balneario Camboriu (SC)
    (-27.0000, -48.6400), (-26.9908, -48.6348), (-26.9800, -48.6200),

    # Buzios (RJ)
    (-22.7800, -41.8600), (-22.7600, -41.9000), (-22.7469, -41.8819),
    (-22.7300, -41.8700), (-22.7100, -41.8500),

    # Angra dos Reis (RJ)
    (-23.0200, -44.3000), (-23.0064, -44.3178), (-22.9900, -44.3300),

    # Paraty (RJ)
    (-23.2100, -44.7000), (-23.2237, -44.7130), (-23.2400, -44.7200),
]
